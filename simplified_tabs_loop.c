...
/*@
   ...
   behavior other:
     ...
     ensures \true;
   complete behaviors case_of_interest, other;
   disjoint behaviors case_of_interest, other;
   //ensures expected_u_signal_max: \result == 1000;
*/
int compute_control_signal(void) {
	...
	/*@
	   ...
	   loop invariant 0 <= i <= 7;
           loop invariant ep_i_1: i == 0 ==> ep_sum == 0;
           loop invariant ep_i_2: (i == 1 &&  ep <= -1000) ==> ep_sum == 1000;
           loop invariant ep_i_3: (i == 1 &&  -1000 < ep < -500) ==> ep_sum == -2*ep -1000;
           loop invariant ep_i_4: (i == 1 &&  ep == -500) ==> ep_sum == 0; 
           loop invariant ep_i_5: (i == 2  &&  ep <= -1000) ==> ep_sum == 1000;   
           loop invariant ep_i_6: (i == 2  &&  -1000 < ep < -500) ==> ep_sum == 1000;
           loop invariant ep_i_7: (i == 2  &&  ep == -500) ==> ep_sum == 1000;
           loop invariant ep_i_8: i > 2 && ep <= -500 ==> ep_sum == 1000;
           //loop invariant ep_i_8: (i == 3  &&  ep == -500) ==> ep_sum == 1000;
           loop variant 7-i;
        */	
        ...
        /*@
           loop assigns numerator, ep_index;
           loop invariant 0 <= ep_index <= 7;
           loop invariant ep_i_1: ep_index == 0 ==> numerator == 0;

           loop invariant ep_i_1: (ep_index >= 1 &&  ep == -500 && e == -500) ==> numerator == 0;
           loop invariant ep_i_2: (ep_index == 1 &&  ep == -500 && -1000 < e < -500) ==> numerator == 0;
           loop invariant ep_i_3: (ep_index == 1 &&  ep == -500 && e == -1000) ==> numerator == 0;
           loop invariant ep_i_4: (ep_index >= 1 &&  -1000 < ep < -500 && e == -500) ==> numerator == 0;
           loop invariant ep_i_5: (ep_index == 1 &&  -1000 < ep < -500 && -1000 < e < -500) ==> numerator == (-2 * ep - 1000) * (-2 * e - 1000);
           loop invariant ep_i_6: (ep_index == 1 &&  -1000 < ep < -500 && e == -1000) ==> numerator == (-2 * ep - 1000) * 1000 * u[NB][0]/1000;
           loop invariant ep_i_7: (ep_index >= 1 &&  ep <= -1000 && e == -500) ==> numerator == 0;
           loop invariant ep_i_8: (ep_index == 1 &&  ep <= -1000 && -1000 < e < -500) ==> numerator == 1000 * (-2 * e - 1000) * u[NB][0]/1000;
           loop invariant ep_i_9: (ep_index >= 1 &&  ep <= -1000 && e == -1000) ==> numerator == 1000 * 1000;

           loop invariant ep_i_10: (ep_index >= 2 &&  ep == -500 && e == -500) ==> numerator == 0;
           loop invariant ep_i_11: (ep_index >= 2 &&  ep == -500 && -1000 < e < -500) ==> numerator == -2000*e - 1000 * 1000; //1000 * (2 *e + 2000);
           loop invariant ep_i_12: (ep_index >= 2 &&  ep == -500 && e == -1000) ==> numerator == 1000 * 1000;
           loop invariant ep_i_13: (ep_index >= 2 &&  -1000 < ep < -500 && e == -500) ==> numerator == 0;
           loop invariant ep_i_14: (ep_index == 2 &&  -1000 < ep < -500 && -1000 < e < -500) ==> numerator == (-2 * ep - 1000) * (-2 * e - 1000)  + (2*ep + 2000) * (-2*e - 1000);
           loop invariant ep_i_15: (ep_index >= 2 &&  -1000 < ep < -500 && e == -1000) ==> numerator == 1000 * 1000;
           loop invariant ep_i_16: (ep_index >= 2 &&  ep <= -1000 && e == -500) ==> numerator == 0;
           loop invariant ep_i_17: (ep_index >= 2 &&  ep <= -1000 && -1000 < e < -500) ==> numerator == 1000 * (-2 * e - 1000) * u[NB][0]/1000;
           loop invariant ep_i_18: (ep_index >= 2 &&  ep <= -1000 && e == -1000) ==> numerator == 1000 * 1000;

           loop invariant ep_i_19: (ep_index >= 2 &&  -1000 < ep < -500 && -1000 < e < -500) ==> numerator == (-2 * ep - 1000) * (-2 * e - 1000)  + (2*ep + 2000) * (-2*e - 1000);

           loop invariant hello: e == -500 && ep_index != NB ==> numerator == 0;
           loop invariant goodbye: e == -500 ==> numerator == 0;
//           loop invariant ep_i_20: (ep_index > 2 && ep <= -500 && -1000 <e <= -500) ==> numerator == -2000*e - 1000 * 1000;
           //loop invariant final_goal : -1000 <e <= -500 && ep <= -500 ==> numerator ==-2000*e - 1000000;
	...
	for (int ep_index = 0; ep_index < 7; ep_index++)
        ...
        //.@ ghost int g_n = numerator;
        //.@ ghost int md_nb_e = mNB(e);
        //.@ ghost int md_0_ep = md(0, ep);
        //.@ ghost int md_1_ep = md(1, ep);
        //.@ ghost int md_2_ep = md(2, ep);
        //.@ ghost int md_3_ep = md(3, ep);
        //.@ ghost int md_4_ep = md(4, ep);
        //.@ ghost int md_5_ep = md(5, ep);
        //.@ ghost int md_6_ep = md(6, ep); 
 
        //.@ assert numerator_holds_after_loop: numerator == loop_2_3_4(6, NB, e, ep);
        //.@ assert numerator_holds: -1000 <e <= -500 && ep <= -500 ==>  numerator == md(NB, e)*md(NB, ep)*u[NB][NB]/1000 + md(NM, e)*md(NM, ep)*u[NB][NM]/1000; //loop_2_3_4_no_recursion(6, NB, e, ep);
        //.@ assert numerator_between_bounds: -7 * 1000 * 1000 * 1000 <= numerator <= 7 * 1000 * 1000 * 1000;
        //.@ assert num_strict_double: e == -500 && ep == -500 ==> numerator == -2000*e - 1000000;
        //.@ assert num_strict_double_2: e == -510 && ep == -510 ==> numerator == -2000*e - 1000000;
        //.@ assert num_strict_single: e == -500 &&  -501 <= ep <= -500 ==> numerator == -2000*e - 1000000;
        //.@ assert num_0000: e == -999 && ep <= 1000 ==> numerator == -2000*e - 1000000;
        //.@ assert num_000: e == -999 && ep <= 500 ==> numerator == -2000*e - 1000000;
        //.@ assert num_00: e == -999 && ep <= 0 ==> numerator == -2000*e - 1000000;
        //.@ assert num_0: e == -999 && ep <= -500 ==> numerator == -2000*e - 1000000;
        ...
        //@ assert check_1: e == -500 ==> numerator == 0;

        //@ assert check_2: -1000 < e < -500 && ep < -1000 ==> numerator == -2000*e - 1000000;
        //@ assert check_3: -1000 < e < -500 && ep == -1000 ==> numerator == -2000*e - 1000000;
        //@ assert check_4: -1000 < e < -500 && -1000 < ep < -500 ==> numerator == -2000*e - 1000000;
        //@ assert check_5: -1000 < e < -500 && ep == -500 ==> numerator == -2000*e - 1000000;


        //@ assert check_6: -1000 < e < -500 && ep <= -500 ==> numerator == -2000*e - 1000000;
        //@ assert check_7: e == -1000 && ep == -1000 ==> numerator == -2000*e - 1000000;
        //@ assert FINAL_____GOAL:  -1000 <e <= -500 && ep <= -500 ==> numerator ==-2000*e - 1000000;
	...
	for (int e_index = 3; e_index < 7; e_index++)
        ...
        */
        ...
        /*@
           ...
           loop invariant 0 <= i <= 7;
           //loop invariant dnm_loop_value: denominator == md_sum(i - 1, e, 1)*ep_sum/1000;
           loop variant 7-i;
        */
        for (int i = 0; i < 7; i++)     //i ∈ {NB, NM, NS, ZE, PS, PM, PB}
                denominator += md(i, e)*ep_sum/1000;

        //.@ assert denominator_result: denominator == mNB(e)*ep_sum/1000 + mNM(e)*ep_sum/1000 + mNS(e)*ep_sum/1000 + mZE(e)*ep_sum/1000 + mPS(e)*ep_sum/1000 + mPM(e)*ep_sum/1000 + mPB(e)*ep_sum/1000;
        //Returns uc.
